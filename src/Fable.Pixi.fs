...
module PIXI =
    ...
    let [<Import("LoaderResource","pixi.js")>] loaderResource: LoaderResource.IExports = jsNative
    ...
    let [<Import("resources","pixi.js")>] resources: Resources.IExports = jsNative
    let [<Import("settings","pixi.js")>] settings: Settings.IExports = jsNative
    let [<Import("systems","pixi.js")>] systems: Systems.IExports = jsNative
...
(* ===================================== TODO =====================================*)
    ...
    module Loaders =
        ...
        type [<AllowNullLiteral>] Loader =
            interface end
//            abstract load: (PIXI.Loaders.Loader -> PIXI.Loaders.Resource -> unit) -> unit
...
*)
    ...
    module Utils =
        let [<Import("mixins","pixi.js/utils")>] mixins: Mixins.IExports = jsNative
